...
function UpdateExchangeSummary()
{
    utils.getJSON('https://'+g_constants.DOMAIN+':'+g_constants.share["my_portSSL"]+'/api/v1/public/getmarkets', (status, data) => {
        ...
        for (let i=0; i<data.result.length; i++)
        {
            ...
            const MDEX = data.result[i].BaseCurrency;
            
            utils.getJSON('https://'+g_constants.DOMAIN+':'+g_constants.share["my_portSSL"]+'/api/v1/public/getmarketsummary?market='+MDEX+'-'+BTC+'&period=24', (status2, data2) => {
